...
describe('admin navigation', () => {
  ...
  it('uses exact matching for overview and selects one most-specific nested workspace', () => {
    ...
    const analytics = ADMIN_NAVIGATION_ITEMS[1];
    const recovery = ADMIN_NAVIGATION_ITEMS[2];
    ...
    expect(isAdminNavigationItemActive(analytics, '/admin/analytics/engagement')).toBe(true);
