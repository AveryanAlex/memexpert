...
COMMON_PROVIDER_AUTH_ENV_KEYS: Final = (
    ...
    "SEARCH_CANDIDATE_POOL_LIMIT_PER_SOURCE",
    "RECOMMENDATION_ENABLED",
    "RECOMMENDATION_SHADOW_MODE",
    "RECOMMENDATION_CANARY_PERCENT",
    "RECOMMENDATION_SHADOW_TIMEOUT_SECONDS",
    "RECOMMENDATION_FEED_POOL_MAX_PER_VIEWER",
    ...
    "SECURITY_RATE_LIMIT_ANALYTICS_WRITE_MAX_REQUESTS",
    "SECURITY_RATE_LIMIT_ANALYTICS_WRITE_WINDOW_SECONDS",
)
