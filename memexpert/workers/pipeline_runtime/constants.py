...
PIPELINE_REASON_SOURCE_ENGAGEMENT_CAPTURE_FAILED = "source_engagement_capture_failed"
PIPELINE_REASON_SOURCE_CHANNEL_AUDIENCE_CAPTURE_FAILED = "source_channel_audience_capture_failed"
PIPELINE_REASON_SOURCE_OBJECT_MISSING = "source_object_missing"
